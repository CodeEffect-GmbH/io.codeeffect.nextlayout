...
const LinkButton: FunctionComponent<PropsWithChildren<LinkButtonProps>> = ({
    ...
    return (
        <LinkEx href={href} title={title} className={`flex items-center cursor-pointer p-4 rounded-lg transition-transform hover:drop-shadow-md hover:scale-105 ${className}`}>
