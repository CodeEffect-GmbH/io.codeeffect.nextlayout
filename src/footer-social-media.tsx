...
const FooterSocialMedia: FunctionComponent<FooterSocialMediaProps> = (props) => {
    return (
        <div>
            {props.title && <div className="mb-2"><Title level={5} compact>{props.title}</Title></div>}
            <div className='flex flex gap-8'>
                {props.linkedIn &&
                    <a className="w-10 h-10 hover:scale-105 hover:drop-shadow-md transition-transform" href={props.linkedIn} title="LinkedIn">
                ...
                {props.youTube &&
                    <a className="w-10 h-10 hover:scale-105 hover:drop-shadow-md transition-transform" href={props.youTube} title="YouTube">
                ...
                {props.instagram &&
                    <a className="w-10 h-10 hover:scale-105 hover:drop-shadow-md transition-transform" href={props.instagram} title="Instagram">
                ...
                {props.facebook &&
                    <a className="w-10 h-10 hover:scale-105 hover:drop-shadow-md transition-transform" href={props.facebook} title="Facebook">
                ...
                {props.x &&
                    <a className="w-10 h-10 hover:scale-105 hover:drop-shadow-md transition-transform" href={props.x} title="X">
